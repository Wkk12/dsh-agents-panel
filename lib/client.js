...
function RulesPanel({ theme }) {
  ...
  const addWs = () => {
    const path = window.prompt("\u5DE5\u4F5C\u533A\u6839\u76EE\u5F55\u8DEF\u5F84\uFF0C\u5982 /Users/\u4F60\u7684\u7528\u6237\u540D/\u9879\u76EE");
    if (path) chooseWs(path);
  };
  const toggle2 = (id) => {
    setChecked((c) => {
      const n = new Set(c);
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1, display: "flex", minHeight: 0 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { width: 280, flexShrink: 0, borderRight: `1px solid ${theme.border}`, display: "flex", flexDirection: "column", minHeight: 0 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 12px", borderBottom: `1px solid ${theme.border}`, flexShrink: 0 } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontSize: 12, color: theme.fg, opacity: 0.65 } }, "\u5DE5\u4F5C\u533A"), /* @__PURE__ */ import_react.default.createElement("button", { onClick: addWs, style: { display: "flex", alignItems: "center", gap: 4, background: "transparent", color: theme.fg, border: `1px solid ${theme.border}`, borderRadius: 7, padding: "3px 9px", fontSize: 12, cursor: "pointer", opacity: 0.8 }, onMouseEnter: (e) => e.currentTarget.style.background = "rgba(128,128,128,.14)", onMouseLeave: (e) => e.currentTarget.style.background = "transparent" }, /* @__PURE__ */ import_react.default.createElement(Icon, { d: IC.plus, size: 12 }), " \u65B0\u589E")), /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1, overflow: "auto", padding: "0 8px 10px" } }, wsKeys.length === 0 && /* @__PURE__ */ import_react.default.createElement("div", { style: { color: theme.fg, opacity: 0.4, fontSize: 12.5, padding: 10 } }, "\u8FD8\u6CA1\u6709\u914D\u7F6E\u8FC7\u5DE5\u4F5C\u533A"), wsKeys.map((w) => /* @__PURE__ */ import_react.default.createElement("div", { key: w, onClick: () => chooseWs(w), style: { display: "flex", gap: 7, alignItems: "center", padding: "6px 8px", borderRadius: 7, fontSize: 12, cursor: "pointer", background: ws === w ? "rgba(128,128,128,.16)" : "transparent", color: theme.fg, wordBreak: "break-all" }, onMouseEnter: (e) => e.currentTarget.style.background = "rgba(128,128,128,.14)", onMouseLeave: (e) => e.currentTarget.style.background = ws === w ? "rgba(128,128,128,.16)" : "transparent" }, w)))), /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", minWidth: 0, minHeight: 0 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "9px 14px", borderBottom: `1px solid ${theme.border}`, flexShrink: 0, flexWrap: "wrap" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontSize: 12, color: theme.fg, opacity: 0.7 } }, "\u52FE\u9009\u672C\u5DE5\u4F5C\u533A\u8981\u4F7F\u7528\u7684\u89C4\u5219(", checked.size, "/", rules.length, ")"), /* @__PURE__ */ import_react.default.createElement("button", { onClick: save, disabled: busy, style: { background: theme.accent, color: "#fff", border: "none", borderRadius: 7, padding: "5px 14px", fontSize: 12, cursor: "pointer", marginLeft: "auto", opacity: busy ? 0.6 : 1 } }, busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u5E76\u751F\u6210\u672C\u5730\u89C4\u5219")), msg && /* @__PURE__ */ import_react.default.createElement("div", { style: { padding: "6px 14px", fontSize: 12, color: theme.dest } }, msg), /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1, overflow: "auto", padding: "10px 14px" } }, cats.map((cat) => /* @__PURE__ */ import_react.default.createElement("div", { key: cat, style: { marginBottom: 14 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontSize: 12.5, fontWeight: 600, color: theme.fg, marginBottom: 6 } }, cat), rules.filter((r) => r.category === cat).map((r) => /* @__PURE__ */ import_react.default.createElement("label", { key: r.id, onClick: () => toggle2(r.id), style: { display: "flex", gap: 9, alignItems: "flex-start", padding: "7px 8px", borderRadius: 8, cursor: "pointer", background: checked.has(r.id) ? "rgba(128,128,128,.12)" : "transparent", transition: "background .15s" } }, /* @__PURE__ */ import_react.default.createElement("input", { type: "checkbox", checked: checked.has(r.id), readOnly: true, style: { marginTop: 2, accentColor: theme.accent } }), /* @__PURE__ */ import_react.default.createElement("span", { style: { flex: 1 } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontSize: 12.5, color: theme.fg, fontWeight: 500 } }, r.name), /* @__PURE__ */ import_react.default.createElement("span", { style: { display: "block", fontSize: 11.5, color: theme.fg, opacity: 0.6, marginTop: 2 } }, r.description)))))))));
}
